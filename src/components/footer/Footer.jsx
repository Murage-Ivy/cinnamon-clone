...
function Footer() {
    ...
    },
    {
        ...
        icon: <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" color="#FFFFFF" style={{ color: "#ffffff" }} height="21" width="21" xmlns="http://www.w3.org/2000/svg"><title>Cinnamon's Facebook</title><path d="M512 256c0 141.4-114.6 256-256 256S0 397.4 0 256C0 125.1 114.6 10 256 0s256 114.6 256 256zm-118.4-1.6h-64.2v-64.2c0-17.8 14.4-32.2 32.2-32.2h32.2V96h-64.2c-53 0-96.2 43.2-96.2 96.2v64.2h-64.2v64.2h64.2v160h64.2V318.2h64.2z"></path></svg>
    },
    {
        id: 3,

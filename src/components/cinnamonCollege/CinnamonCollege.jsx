...
function CinnamonCollege() {
    ...
    const positionItems = positions.map(position => <div className='grid grid-cols-[85%_auto] items-center  border-b-2 border-gray-600 py-6'>
    ...
    return (<>
        ...
        <div className='text-white px-5 pt-20'>
            <div className='mb-16'>
